  ...
  useEffect(() => {
    const handleResize = () => {
      if (wrapperRef.current && textDimensions.width && textDimensions.height) {
        ...
        const finalWidth = (parentRect && parentRect.width > 0) ? parentRect.width : window.innerWidth;
        const finalHeight = (parentRect && parentRect.height > 0) ? parentRect.height : window.innerHeight;
